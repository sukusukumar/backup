...
//BASE_URL:'http://52.11.136.14:8080/IAPORTAL/',
	//MEASUREMENT_URL :'http://52.11.136.14:8080/IAPORTAL/rest/measurement/',
...
testplanAdminGridOptions :{
		...
		columnDefs: [
			...
			{ name: 'jobId',width:250 },
			{ name: 'virtualDeviceId',width:200 },
			{ name: 'virtualDeviceName',width:230 }
