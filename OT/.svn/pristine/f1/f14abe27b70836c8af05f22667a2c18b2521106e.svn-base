...
//Tree api
    alert($.cookie('token'));
    $.ajax({
        url: "http://10.10.52.147:8080/IAPORTAL/rest/testPlan/fetchCommands",
        type: "POST",
...
//                            console.log('t1: '+ t1);
                            ...
                            h = testexe.slice(-1);
                            k = ui.element;
                            console.log('ui.element: ' + JSON.stringify(ui.element))
                            i = i + 1;
...
//                  var taskExecutor = JSON.stringify(data));
...
//convert month to 2 digits
                ...
                $.ajax({
                    url: "http://10.10.52.147:8080/IAPORTAL/rest/testPlan/createTestplan",
                    type: "POST",
                    data: Creat_data,
                    headers: {
                        'Content-Type': 'application/x-www-form-urlencoded'
